...
//   DropTarget,
// } from 'react-dnd';
import type { MosaicContext, MosaicWindowContext } from "./type/contextTypes";
...
//   renderPreview?: (props: MosaicWindowProps<T>) => Element;
//   renderToolbar?:
//     | ((props: MosaicWindowProps<T>, draggable: boolean | undefined) => Element)
//     | null;
//   onDragStart?: () => void;
...
export class InternalMosaicWindow<T extends MosaicKey> {
...
//   render() {
//     return (
//       <SourceDropConnectedInternalMosaicWindow
